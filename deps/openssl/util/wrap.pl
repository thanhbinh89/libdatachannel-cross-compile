...
BEGIN {
    ...
    require '/home/binh/Camera/libdatachannel-cross-compile/deps/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/binh/Camera/libdatachannel-cross-compile/deps/openssl/test/fips-and-base.cnf';
    shift;
